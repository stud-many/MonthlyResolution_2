...
class outlay():
    ...
    def __init__(self, new_id , new_amount,new_days):
        self.per_id = new_id
...
class month():
    ...
    #initiiere monat
        ...
        self.processed = False #Kann abgeschafft werden, wenn die Datenverarbeitung auf größere Datenmengen ausgelegt wird. Eventuell für neue Versionsnummer
    ...
    #initiiere zahlungen
        ...
        for per_id in self.active_id_list:
            ...
            self.outlays.append(outlay(per_id, new_outlay_amount, new_outlay_days))
